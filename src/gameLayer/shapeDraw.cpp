...
void ShapeDraw::init(int w, int h)
{
...
void ShapeDraw::updateWindowMetrics(int w, int h)
{
...
void ShapeDraw::flush(Camera& camera)
{	
...
void ShapeDraw::drawTriangleMesh(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 color)
{
	drawLine(a, b, color);
	drawLine(b, c, color);
	drawLine(c, a, color);
...
void ShapeDraw::drawTriangleSolid(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 color)
{
...
void ShapeDraw::drawTriangleTransparent(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec4 color)
{
...
void ShapeDraw::drawTriangleFancy(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec4 color)
{
	drawTriangleMesh(a, b, c, color);
	drawTriangleTransparent(a, b, c, color);
}

void ShapeDraw::drawLine(glm::vec3 a, glm::vec3 b, glm::vec3 color)
{
	lineData.push_back({a, color});
	lineData.push_back({b, color});
}

void ShapeDraw::drawPoint(glm::vec3 a, glm::vec3 color)
{
